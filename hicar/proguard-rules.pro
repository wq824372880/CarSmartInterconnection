...
#所有GSON生成的对象类不能被混淆
-keep class com.zeekrlife.hicar.data.response.**{*;}
-keep class com.zeekrlife.hicar.data.request.**{*;}

-keep class com.zeekrlife.hicar.app.**{*;}
-keep class com.zeekrlife.hicar.data.**{*;}
