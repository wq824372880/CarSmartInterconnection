...
class ConnectCodeView constructor(
    ...
    private var binding: ConnectCodeViewBinding
    ...
    fun showCodeNumber(str: String) {
        ...
        "showCodeNumber: $str".logE("ConnectCodeView")
        codeList.let {
    ...
    fun showErrorPage() {
        ...
        refreshPage()
        binding.failedTV.text = context.getString(R.string.app_connect_fail_manual)
    }
