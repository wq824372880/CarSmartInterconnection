...
#所有GSON生成的对象类不能被混淆
-keep class com.zeekrlife.connect.data.response.**{*;}
-keep class com.zeekrlife.connect.data.request.**{*;}

-keep class com.zeekrlife.connect.app.**{*;}
-keep class com.zeekrlife.connect.data.**{*;}
