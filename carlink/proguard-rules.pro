...
#所有GSON生成的对象类不能被混淆
-keep class com.zeekrlife.carlink.data.response.**{*;}
-keep class com.zeekrlife.carlink.data.request.**{*;}

-keep class com.zeekrlife.carlink.app.**{*;}
-keep class com.zeekrlife.carlink.data.**{*;}
