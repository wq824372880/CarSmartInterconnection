...
public class DeviceApiImpl extends DeviceAPI {
    ...
    private static final Singleton<DeviceApiImpl> deviceApiSingleton = new Singleton<DeviceApiImpl>() {
        @KeepName
    ...
    public void init(Context context, ApiReadyCallback apiReadyCallback) throws IllegalStateException {
        if (isSuccess) {
            ...
            if (Thread.currentThread() == Looper.getMainLooper().getThread()) {
                new Thread(() -> init(apiReadyCallback)).start();
            } else {
