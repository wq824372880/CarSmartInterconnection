...
//    @Domain(name = "BaseUrlOperate") //设置为默认域名
//    const val BASE_URL_OPERATE = "https://snc-manage-dev.zeekrlife.com"
    ...
    //获取应用的安裝数字签名
    const val APP_INSTALL_DIGITAL_SIGNATURE = "clientApi/${API_VERSION_V1}/app/signature"

    //获取应用属性
    const val APP_ATTRIBUTES = "clientApi/${API_VERSION_V1}/app/attributes"
