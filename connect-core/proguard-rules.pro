...
-dontwarn com.effective.android.anchors.**
...
#所有GSON生成的对象类不能被混淆
-keep class com.zeekrlife.connect.core.data.response.**{*;}
-keep class com.zeekrlife.connect.core.data.request.**{*;}
-keep class com.zeekrlife.connect.core.data.database.**{*;}

-keep class com.zeekrlife.connect.core.app.**{*;}
-keep class com.zeekrlife.connect.core.data.**{*;}
-keep class com.zeekrlife.net.**{*;}
-keep class com.socks.library.**{*;}
#埋点SDK
-keep class com.zeekr.zdataprovider.** { *; }
-keep class * implements android.os.Parcelable{*;}
